 ...
 * as the target method. If an argument or return value is not
 * directly accessible by your code, you may use a proxy interface
 * in the signature instead; the types will be automatically bridged
 * at runtime.
 */
